...
public class JFontChooser extends JComponent
{
	...
	private static final Font DEFAULT_SELECTED_FONT = new Font("Alex",
			Font.PLAIN, 22);
	...
	// ResourceBundle.getBundle(JFontChooser.class.getName() + "Messages",
	// getLocale());
	//
	...
	{
		InputStream istream = getClass().getResourceAsStream("/com/jci/alex/res/font/"+getSelectedFontFamily());
		Font font =null;
		try
		{
			font = Font.createFont(Font.TRUETYPE_FONT, istream);
			font = font.deriveFont(getSelectedFontStyle(), getSelectedFontSize());
...
//				getSelectedFontSize());
	...
	protected String[] getFontFamilies()
	{
		if (fontFamilyNames == null)
		{
			...
			fontFamilyNames = new String[4];
			fontFamilyNames[0]="Alex.ttf";
			fontFamilyNames[1]="DeBiao.ttf";
			fontFamilyNames[2]="Tangerine.ttf";
			fontFamilyNames[3]="XuJingLei.ttf";
