...
public class UndoRedoSupport
{
	...
	UndoRedoSupport(JTextComponent textComponent, ResourceBundle messages)
	{
		...
		KeyStroke key = KeyStroke.getKeyStroke(KeyEvent.VK_Z, Toolkit
				.getDefaultToolkit().getMenuShortcutKeyMask());
		inputMap.put(key, "undo");
		textComponent.getActionMap().put("undo", undoAction);
		key = KeyStroke.getKeyStroke(KeyEvent.VK_Y, Toolkit.getDefaultToolkit()
	 ...
	 * 
	 * Calling startCompoundEdit when already in compound mode is an error and
	 ...
	 * 
	 * Calling endCompoundEdit when not in compound mode is an error and will
	...
	class RedoAction extends AbstractAction
	{
		...
		private RedoAction()
		{
			...
			KeyStroke key = KeyStroke.getKeyStroke(KeyEvent.VK_Y, Toolkit
					.getDefaultToolkit().getMenuShortcutKeyMask());
			putValue(Action.ACCELERATOR_KEY, key);
